      ...
      <div className="container mx-auto max-w-4xl">
        <div className="text-center">
          ...
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">
            Intelligence, not <span className="gradient-text">Hallucination</span>.
          </h2>
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-12">
            ...
            from elite institutions, balanced with student essays from diverse
            universities to ensure your voice is preserved, not erased.
          </p>
